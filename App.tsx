...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen selection:bg-[#b37a5d] selection:text-white antialiased">
      ...
      {/* HERO SECTION */}
      <section className="pt-32 pb-20 md:pt-52 md:pb-40 px-6 relative overflow-hidden bg-[#e9e5d9]">
        ...
        <div className="max-w-6xl mx-auto space-y-32 md:space-y-48">
          ...
          <div className="reveal relative bg-white border border-stone-200 p-8 md:p-24 shadow-2xl rounded-sm">
             <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
                ...
                <blockquote className="text-xl md:text-3xl serif italic text-[#b37a5d] mb-12 relative px-4">
                  <span className="absolute -left-2 -top-4 text-6xl text-stone-100 serif">"</span>
                  Acaso não sabem que o corpo de vocês é santuário do Espírito Santo?
                  <span className="text-xs not-italic font-bold text-stone-400 uppercase tracking-widest block mt-6">— 1 Coríntios 6:19</span>
                </blockquote>
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 text-left w-full mt-4">
                   <div className="p-8 border-l-4 border-[#6b705c] bg-stone-50 md:bg-transparent transition-colors hover:bg-stone-50">
                      <h4 className="font-bold text-sm uppercase mb-3 text-[#433832]">Atividade como Adoração</h4>
          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-stretch">
            <div className="reveal flex flex-col">
              ...
              <p className="text-stone-500 italic mb-10">"Ferro afia ferro" — Provérbios 27:17</p>
              <div className="space-y-4 flex-grow">
                 <div className="flex items-center justify-between p-5 bg-stone-50 border border-stone-100 hover:border-[#b37a5d]/30 transition-all cursor-default">
                    <span className="text-xs font-bold uppercase tracking-wider">Namoro Cristão Intencional</span>
                    <HeartIcon className="w-5 h-5 text-[#b37a5d] flex-shrink-0" />
                 </div>
                 <div className="flex items-center justify-between p-5 bg-stone-50 border border-stone-100 hover:border-[#b37a5d]/30 transition-all cursor-default">
                    <span className="text-xs font-bold uppercase tracking-wider">Casamento como Ministério</span>
                    <UserGroupIcon className="w-5 h-5 text-[#b37a5d] flex-shrink-0" />
                 </div>
                 <div className="flex items-center justify-between p-5 bg-stone-50 border border-stone-100 hover:border-[#b37a5d]/30 transition-all cursor-default">
                    <span className="text-xs font-bold uppercase tracking-wider">Comunidade e Amizades</span>
                    <SparklesIcon className="w-5 h-5 text-[#b37a5d] flex-shrink-0" />
                 </div>
              </div>
            </div>
            ...
            <div className="reveal flex flex-col">
              ...
              <div className="bg-[#433832] text-white p-10 rounded-sm mt-auto shadow-xl relative overflow-hidden group">
                 <div className="absolute top-0 right-0 w-32 h-32 bg-[#b37a5d]/10 rounded-full -mr-16 -mt-16 transition-transform group-hover:scale-110"></div>
                 ...
                 <p className="text-sm opacity-80 leading-relaxed relative z-10">Escrita de um plano de vida para as próximas décadas (5, 10 e 20 anos) integrando fé, família e vocação.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-[#433832] text-white px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="reveal p-10 bg-white/5 border border-white/10 rounded-sm hover:bg-white/10 transition-all flex flex-col items-center text-center md:items-start md:text-left">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-stretch">
            ...
            <div className="bg-[#433832] text-white p-10 md:p-12 shadow-2xl relative reveal border-t-8 border-[#b37a5d] flex flex-col">
              ...
              <div className="space-y-6 mb-12 flex-grow">
                 <div className="flex items-start space-x-4 bg-white/5 p-4 rounded-sm border border-white/5">
                    <CheckBadgeIcon className="w-6 h-6 text-[#b37a5d] flex-shrink-0" />
      ...
      {/* FOOTER */}
      <footer className="bg-[#e9e5d9] py-32 px-6 border-t border-stone-300 relative overflow-hidden">
        <div className="max-w-6xl mx-auto flex flex-col items-center text-center relative z-10">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full select-none pointer-events-none opacity-[0.03] overflow-hidden whitespace-nowrap">
             <h2 className="text-[18vw] serif italic text-[#433832] leading-none">Dúvidas?</h2>
          </div>
          
          <SunIcon className="w-16 h-16 text-[#b37a5d] mb-12 relative" />
          <h3 className="text-2xl md:text-3xl serif mb-12 text-[#433832] relative">Ainda tem alguma dúvida sobre a Jornada?</h3>
          
          <div className="flex flex-col md:flex-row gap-6 mb-24 w-full justify-center max-w-lg relative">
            <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-5 p-6 border border-stone-300 hover:border-[#b37a5d] transition-all bg-white/50 w-full group rounded-sm shadow-sm">
              <div className="w-12 h-12 bg-[#b37a5d]/10 rounded-full flex items-center justify-center group-hover:bg-[#b37a5d]/20 transition-colors flex-shrink-0">
                <DevicePhoneMobileIcon className="w-6 h-6 text-[#b37a5d]" />
              </div>
              <div className="text-left">
                <div className="text-[10px] font-black uppercase opacity-50 tracking-widest">WhatsApp Suporte</div>
          ...
          <div className="pt-20 border-t border-stone-300/50 w-full">
            ...
            <div className="flex space-x-8 md:space-x-12 justify-center text-[9px] font-bold uppercase tracking-widest opacity-40">
               <a href="#" className="hover:text-[#b37a5d] transition-colors">Privacidade</a>
               <a href="#" className="hover:text-[#b37a5d] transition-colors">Termos</a>
               <a href="#" className="hover:text-[#b37a5d] transition-colors">LGPD</a>
            </div>
          </div>
        </div>
      </footer>
      ...
      <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 w-14 h-14 md:w-16 md:h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-all outline-none focus:ring-4 focus:ring-[#25D366]/50">
